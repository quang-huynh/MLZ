...
For a multispecies or multi-stock analysis (Huynh et al. 2017), seperate `MLZ_data` objects are created for seperate stocks/species and should be stored in a list:
```{r}
data(PRSnapper)
typeof(PRSnapper)
```
